...
export const BarChart3Icon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2Zm0 1h12v12H2V2Zm2 3a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5Zm5-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-2Z"
      clipRule="evenodd"
    />
  </svg>
);
...
export const PieChartIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1ZM2.5 8a5.5 5.5 0 1 1 11 0 5.5 5.5 0 0 1-11 0ZM8 3.5a4.5 4.5 0 0 0-4.5 4.5h4.5V3.5Zm0 4.5H3.5a4.5 4.5 0 0 0 4.5 4.5V8Z"
      clipRule="evenodd"
    />
  </svg>
);

export const TrendingUpIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
